...
post_test_performance <- data.frame(
  model = c("lm", "poisson", "quasi_poisson", "neg_bin"),
  MAE = c(
    MAE(test_res_p$pred_lm, test_res_p$n_pharmacies),
    MAE(test_res_p$pred_poisson, test_res_p$n_pharmacies),
    MAE(test_res_p$pred_quasipoisson, test_res_p$n_pharmacies),
    MAE(test_res_p$pred_quasipoisson, test_res_p$n_pharmacies)
  ),
  RMSE = c(
    RMSE(test_res_p$pred_lm, test_res_p$n_pharmacies),
    RMSE(test_res_p$pred_poisson, test_res_p$n_pharmacies),
    RMSE(test_res_p$pred_quasipoisson, test_res_p$n_pharmacies),
    RMSE(test_res_p$pred_quasipoisson, test_res_p$n_pharmacies)
  ),
  R2 = c(
    R2(test_res_p$pred_lm, test_res_p$n_pharmacies),
    R2(test_res_p$pred_poisson, test_res_p$n_pharmacies),
    R2(test_res_p$pred_quasipoisson, test_res_p$n_pharmacies),
    R2(test_res_p$pred_quasipoisson, test_res_p$n_pharmacies)
  )
)
