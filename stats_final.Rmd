...
results <- resamples(list(linear = lm_fit_pharmacy, poisson = poisson_fit_pharmacy))
summary(results)

#Importance variables
varImp(lm_fit_pharmacy)
varImp(poisson_fit_pharmacy)
...
test_phar %>% select(n_pharmacies, pred_lm, pred_poisson)

#Compare model performance on testData
postResample(
  pred = test_phar$pred_lm,
